...
public class homeViewController implements Initializable {
    ...
    String userHome = System.getProperty("user.home");
            ...
            File f = new File(userHome+"\\ideaProjects\\searching\\src\\main\\resources\\data");
...
//TODO list all file and picture in observable list 
        for (File str : list) {
            if (!(str.getName().contains(".txt"))) {
                ...
                image.add("/data/" + str.getName());
            } else {
                linkfile.add(userHome+"\\ideaProjects\\searching\\src\\main\\resources\\data\\" + str.getName());
